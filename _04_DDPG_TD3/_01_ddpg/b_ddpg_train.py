...
class DDPG:
    def __init__(self, env: gym.Env, test_env: gym.Env, config: dict, use_wandb: bool):
        ...
        self.buffer = ReplayBuffer(capacity=self.replay_buffer_size)
    ...
    def train_loop(self) -> None:
        ...
        policy_loss = critic_loss = avg_mu_v = 0.0
        ...
        for n_episode in range(1, self.max_num_episodes + 1):
            ...
            while not done:
                ...
                if self.time_steps % self.steps_between_train == 0 and self.time_steps > self.batch_size:
                    policy_loss, critic_loss, avg_mu_v = self.train()
    ...
    def train(self) -> tuple[float, float, float]:
        ...
        observations, actions, next_observations, rewards, dones = self.buffer.sample(self.batch_size)
