...
from c_qnet import MODEL_DIR, ReplayBuffer, Transition
from networks.pointer_network import PointerNetwork
...
class DQN:
    def __init__(self, env: gym.Env | MultiDimKnapsack, test_env: gym.Env, config: dict, use_wandb: bool):
        ...
        # network
        n_features = self.env.observation_space.shape[1]
        n_actions = self.env.action_space.n
        self.q = PointerNetwork(
            embed_input_size=n_features,
            embed_size=32,
            weight_size=256,
            answer_seq_len=n_actions,
            hidden_size=512,
