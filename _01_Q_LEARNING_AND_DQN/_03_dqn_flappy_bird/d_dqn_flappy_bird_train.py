...
def main() -> None:
    ...
    config = {
        ...
        "max_num_episodes": 5_000,                        # 훈련을 위한 최대 에피소드 횟수
        ...
        "validation_time_steps_interval": 3_000,          # 검증 사이 마다 각 훈련 episode 간격
        "validation_num_episodes": 3,                     # 검증에 수행하는 에피소드 횟수
        "episode_reward_avg_solved": 25,                  # 훈련 종료를 위한 검증 에피소드 리워드의 Average
    }

    qnet = QNet(n_actions=2)
    target_qnet = QNet(n_actions=2)
